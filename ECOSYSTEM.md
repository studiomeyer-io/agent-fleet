...
Agent Fleet is the orchestration layer. It runs multiple specialized agents in parallel, each with their own MCP tools. Combined with StudioMeyer Memory for persistent context and Darwin for self-improving prompts, you get a full production agent stack.
